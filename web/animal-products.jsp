...
<%
    ...
    AnimalProduct product1 = (AnimalProduct) request.getAttribute("product");
        ...
        <div class="col s12 m8 l8">
            <table class="highlight">
                ...
                <tr>
                    ...
                    <td>
                        <a href="animal-products?did=<%=product.getId()%>" class="btn-small red darken-4"><i class="fa fa-trash"></i></a>
                        <a href="animal-products?eid=<%=product.getId()%>"  class="btn-small"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
        ...
        <div class="col s12 m4 l4">
            <div class="center card" style="padding: 20px">
                ...
                <form action="animal-products" method="post">
                    ...
                    <div class=" form-group">
                        <label>Item Description</label>
                        <textArea  value="<%=product1.getDescription()%>"  id="description" name="description" style="width: 100%; height: 200px;" ></textArea>
                    </div>
                    <div class="form-group">
