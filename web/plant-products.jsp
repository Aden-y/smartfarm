        ...
        <div class="col s12 m8 l8">
            <table class="highlight">
                ...
                <tr>
                    ...
                    <td>
                        <a href="plant-products?did=<%=product.getId()%>" class="btn-small red darken-4"><i class="fa fa-trash"></i>delete</a>
                        <a href="plant-products?eid=<%=product.getId()%>"  class="btn-small"><i class="fa fa-edit"></i>Edit</a>
                    </td>
                </tr>
